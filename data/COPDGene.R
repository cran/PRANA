...
#' rnaseqdat # RNA-Seq data containing 28 COPD-related genes discussed in Sakornsakolpat et al. Nat Genet, 2019.
#' phenodat # Dataset with clinical covariates.
"combinedCOPDdat_RGO"
