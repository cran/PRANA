...
## Requirements
Please install these R packages prior to use PRANA. Note that minet package is available in Bioconductor. Please see below for further instruction.
```{r}
...
As an additional step, we can use `rename_genes` function from `dnapath` dependency package to rename Entrez gene IDs into gene symbols.
```{r}
